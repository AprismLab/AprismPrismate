...
> Version: v26.1-Alpha.9 | Status: Implemented (release candidate)
...
### Step 3 — AjeDiscovery + AjeExtractor
...
### Step 5 — Fabric entrypoint + classloader bridge (M1/M2)
...
### Step 7 — NeoForge entrypoint + bridge (M3)
...
### Step 8 — Mutual exclusion guard (M5)
...
- Unit tests (common): manifest parse, discovery, extraction, dependency
  resolution, lifecycle dispatch order — all runnable headless.
